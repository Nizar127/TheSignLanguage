...
public class SearchText extends AppCompatActivity implements View.OnClickListener {
    static final int REQUEST_CODE =1234;
    EditText entertext;
    ImageView imagev;
    ImageButton searchbtn, vsearchbtn, exitbtn, signbtn;
